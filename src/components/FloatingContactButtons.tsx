...
export default function FloatingContactButtons() {
  const phoneNumber = "918969858105";
  const whatsappMessage = "Hello, I would like to know more about Astro Om Education.";
  ...
  return (
    <div className="fixed bottom-6 right-6 z-50 flex flex-col gap-4 print:hidden">
      ...
      <motion.a
        ...
        whileHover={{ scale: 1.1 }}
        whileTap={{ scale: 0.9 }}
        className="w-14 h-14 bg-indigo-600 rounded-full flex items-center justify-center shadow-lg hover:shadow-xl transition-shadow group relative"
        aria-label="Call Us"
      >
